	...
	if($('form.form_afterhour').length > 0 || $('form.form_work_diary').length > 0) {
		$('.btn-submit').on('click',function(e) {
			if ( $('form.form_afterhour').length > 0) {
				select_projects = $('#select_project').val();
			} else {
			...
			if ( $('form.form_afterhour').length > 0 && select_projects == null ) {
				e.preventDefault();
				if(select_projects == null) {
					$('#select_project1').css('border-color','red');
				}
				alert ("Nije moguće spremiti zahtjev bez odabranog projekta");

			} else if( $('form.form_work_diary').length > 0 && ( select_projects == null || select_tasks == null)  ) {
				e.preventDefault();
				if(select_projects == null) {
					$('#select_project1').css('border-color','red');
				}
			...
			} else if ( $('form.form_work_diary').length > 0 ) {
