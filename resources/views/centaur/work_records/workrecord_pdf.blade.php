...
<html lang="hr" style="font-size: 12px;font-family: Arial, sans-serif;">
	...
	<body style="font-family: DejaVu Sans;">
		...
		<div class="index_page " >
			<main class="col-lg-12 col-xl-12 index_main evidention_employee">2020-11-19 08:02:00
					...
					<main class="">
						<div class="employee_view">
							<div class="table-responsive" style="width:80%">
								<table id="index_table" class="display table table-hover sort_0" style="font-size: 10px; position: relative;font-family: Arial, sans-serif;border-collapse: separate;border-spacing: 0;">
									...
									<tbody style="display: table-row-group;vertical-align: middle;border-color:inherit;font-family: Arial, sans-serif;font-size:10px;">
										...
										<tr style="display: table-row;font-family: Arial, sans-serif;font-size:10px;background-color: #ccc;">
									...
									<tfoot style="display:table-footer-group;vertical-align: middle;border-color:inherit;font-family: Arial, sans-serif;font-size: 10px;background-color: #ccc;"> 
