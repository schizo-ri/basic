<div class="modal-header">
	<h3 class="panel-title">@lang('basic.add_projects')</h3>
</div>
<div class="modal-body">
	<form accept-charset="UTF-8" role="form" method="post" action="{{ route('projects.store') }}" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="form-group {{ ($errors->has('erp_id')) ? 'has-error' : '' }}">
				...
				<input class="form-control" name="erp_id" type="text" maxlength="20" value="{{ old('erp_id') }}" required />
			...
			<div class="form-group {{ ($errors->has('customer_oib')) ? 'has-error' : '' }}">
				...
				<input class="form-control" name="customer_oib" type="text" maxlength="20" value="{{ old('customer_oib') }}" required />
