...
<div class="modal-body">
    <form accept-charset="UTF-8" role="form" method="post" action="{{ route('competence_group_questions.update', $competenceGroup->id ) }}">
        <div class="form-group {{ ($errors->has('name'))  ? 'has-error' : '' }}">
            ...
            <input name="nameUKR" type="text" class="form-control margin_t_10" value="{{ $competenceGroup->nameUKR }}" maxlength="100" placeholder="Ukrajinski prijevod" >
        ...
        <div class="form-group clear_l {{ ($errors->has('description')) ? 'has-error' : '' }}">
            ...
            <textarea name="descriptionUKR" class="form-control margin_t_10" type="text" maxlength="65535" placeholder="Ukrajinski prijevod" >{{ $competenceGroup->descriptionUKR }}</textarea>
                ...
                @foreach ($competenceGroup->hasQuestions as $key => $question)
                    ...
                    <div class="overflow_hidd rating_group">
                        <div>
                            ...
                            <input name="q_nameUKR[]" type="text" class="form-control margin_t_10" maxlength="191" placeholder="Ukrajinski prijevod"  value="{{ $question->nameUKR }}" >
                        </div>
                        <div>
                            ...
                            <textarea name="q_descriptionUKR[]" class="form-control margin_t_10" type="text" maxlength="65535" placeholder="Ukrajinski prijevod">{{ $question->descriptionUKR }}</textarea>
                        </div>
                        <div>
