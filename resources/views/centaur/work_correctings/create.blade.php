<div class="modal-header">
	<h3 class="panel-title">Prijava popravka rada</h3>
</div>
<div class="modal-body">
	<form accept-charset="UTF-8" role="form" method="post" action="{{ route('work_correctings.store') }}" >
		...
		<div class="form-group">
			...
			<select class="form-control" name="project_id" value="" required>
				<option value="" selected>
		...
		<div class="form-group col-md-12 clear_l overflow_hidd padd_0 time_group" >
			...
			<div class="form-group time ">
				<input type="time" class="form-control" name="time" value="0:00" required>
			</div>
		</div>
		<div class="form-group clear_l {{ ($errors->has('comment')) ? 'has-error' : '' }}">
			<label>@lang('basic.comment')</label>
			<textarea rows="4" name="comment" type="text" class="form-control" maxlength="16535" required>{{ old('comment') }}</textarea>
