<div class="modal-header">
    <h3 class="panel-title">@lang('basic.add_competence')</h3>
</div>
        ...
        <div class="form-group">
            ...
            @for ($i = 0; $i < 5; $i++)
                <p class="overflow_hidd rating_group">
                    ...
                    <span class="rating_span col-12 float_left margin_t_10"><input name="r_descriptionUKR[]" type="text" placeholder="Ukrajinski prijevod"/></span>
                </p>
            @endfor
