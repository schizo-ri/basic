...
<div class="col-12 day_events load_content">
    <div class="col-12">
        <h6>Global events <a class="three_dots" rel="modal:open" href="{{ route('all_event', ['dataArr_day' => $dataArr_day, 'uniqueType' => $uniqueType, 'dan' => $selected_day] ) }}" > @lang('basic.view_all')</a></h6>
                                ...
                                @if ( $data_day['name'] != 'holiday')
                                    @if ($data_day['type'] == $type )
                                        ...
                                        <span class="event_user">
                                            ...
                                            {!! isset($data_day['employee'] )? $data_day['employee']  : '' !!}
                                        </span>
                                        @php
                                            $x++;
                                        @endphp
