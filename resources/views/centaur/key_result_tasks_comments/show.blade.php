...
<div class="modal-body">
    <form class="form_okr form_store clearfix" accept-charset="UTF-8" role="form" method="post" action="{{ route('key_result_tasks_comments.store') }}" >
        <input type="hidden" name="key_result_tasks_id" value="{{ $task_id }}">
