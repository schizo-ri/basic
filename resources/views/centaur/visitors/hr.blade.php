			...
			<div class="container">				
				<main class="visitors">
					<section class="hr col-md-12" >			
						...
						@include('Centaur::visitors.smjernice',['card_id' => $card_id])
						
						<p class="gdpr">* Vaše osobne podatke obrađujemo sukladno članku 6. Opće uredbe o zaštiti podataka (GDPR), a u svrhu poštivanja pravnih obveza Duplico d.o.o. i zaštite Vaših ključnih interesa.</p>
