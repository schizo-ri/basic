...
class KeyResultTaskMail extends Mailable
{
    ...
    {
        $mail_template = MailTemplate::orderBy('created_at','DESC')->where('for_mail','KeyResultTaskMail')->first();
        $mail_style = array();
        ...
        return $this->view('emails.key_result_tasks.create')
                    ->subject( 'Kreiran ' . ' je ' . ' novi ' . ' zadatak ' . ' Ključnog ' . ' rezultata' )
                    ->with([
