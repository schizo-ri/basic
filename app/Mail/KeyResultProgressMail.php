...
class KeyResultProgressMail extends Mailable
{
    ...
    {
        $mail_template = MailTemplate::orderBy('created_at','DESC')->where('for_mail','KeyResultProgressMail')->first();
        $mail_style = array();
        ...
        return $this->view('emails.key_results.progress')
                    ->subject( 'Ključni ' . ' rezultati - promjena ' . ' statusa' )
                    ->with([
