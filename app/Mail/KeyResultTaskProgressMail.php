...
class KeyResultTaskProgressMail extends Mailable
{
    ...
    {
        $mail_template = MailTemplate::orderBy('created_at','DESC')->where('for_mail','KeyResultTaskProgressMail')->first();
        $mail_style = array();
        ...
        return $this->view('emails.key_result_tasks.progress')
                    ->subject( 'Zadatak ' . ' Ključnog rezultata - promjena ' . ' statusa' )
                    ->with([
