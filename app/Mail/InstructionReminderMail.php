...
class InstructionReminderMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $link = $_SERVER['APP_URL']  . '/radne_upute';

        return $this->view('emails.instructions.reminder')
                    ->subject( __('ctrl.instruction_reminder') )
                    ->with([
