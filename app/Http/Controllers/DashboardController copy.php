...
class DashboardController extends Controller
{
    ...
    public function index(Request $_request )
    {
        ...
        foreach($projects as $project) {
            ...
            $count = count(ProjectEmployee::where('project_id', $project->project_no)->get());
            
            $title = $project->project_no . ' | Dodijeljeno ljudi: ' . $count;
            ...
            for ($i=0; $i <= $project_duration ; $i++) {
                ...
                array_push($dataArr, ['id'=>$project->project_no ,'title' => $title , 'start' => $start_date, 'end' => $end_date, 'classNames' => $project->project_no, 'url' => $url ]);
            }
        }
