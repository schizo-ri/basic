...
class ApiController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        /* $response = $this->send_leave_request( Absence::find(3658), 'abs' ); // bolovanje */
        /* $response = $this->send_leave_request( Absence::find(3655), 'abs' ); // GO */
        /*   $response = $this->send_leave_request( Absence::find(3629), 'abs' ); // izlazak */
         /*   $response = $this->send_leave_request( Afterhour::find(2094), 'aft' ); // Afterhour */
    ...
    function send_leave_request( $absence, $abs_type ) 
    {
        ...
        if( $abs_type == 'abs' ) {
            ...
            $date_to =  $absence->end_date ? $absence->end_date : $absence->start_date;
