...
class SuitabilityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Centaur::suitabilities.index', ['benefits' => $benefits,'permission_dep' => $permission_dep]);
    }
    ...
    {
        return view('Centaur::suitabilities.create');
    }
    ...
    {
        $benefit = Suitability::find($id);
		
		return view('Centaur::suitabilities.edit', ['benefit' => $benefit ]);
    }
